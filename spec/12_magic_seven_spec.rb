...
describe MagicSeven do
  ...
  describe '#subtract_four' do
    context 'when the number is 16' do
      it 'returns 12' do
        number = 16
  ...
  describe '#subtract_random_number' do
    context 'when the number is 16 and the random number is 8' do
      it 'returns 8' do
        random_number = 8
        number = 16
  ...
  describe '#play' do
    ...
    context 'when the random number is 1978' do
      subject(:game) { described_class.new(1978) }
